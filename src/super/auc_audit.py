...
class handler:
    def GET(self):
        ...
        return render.auc_audit(helper.get_session_uname(), helper.get_privilege_name(), helper.get_session_addr(),
            r1['data']['auction_list'], int(user_data['page']), len(r1['data']['auction_list'])==setting.PAGE_SIZE)
